...
from Am import BOT_USERNAME, OWNER_ID,BOT_NAME, OWNER_ID, telethn
from Am.Plugins.disable import DisableAbleCommandHandler
from telegram import Update, ParseMode
from Am.events import register
from telegram.ext import CallbackContext, run_async
from Am.Handlers.validation import validation_of_user
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./Am/resources/fonts/*")
...
━━━━━━━{BOT_NAME}━━━━━━━""",
        ...
        await event.reply(f"ᴇʀʀᴏʀ {e}, ʀᴇᴩᴏʀᴛ ᴛʜɪs ᴀᴛ @DANGEROUS_FIGHTER_GROUP ")


__mod_name__ = "Lᴏɢᴏ"

__help__ = """
@N3ON_xD ᴄᴀɴ ᴄʀᴇᴀᴛᴇ sᴏᴍᴇ ʙᴇᴀᴜᴛɪғᴜʟ ᴀɴᴅ ᴀᴛᴛʀᴀᴄᴛɪᴠᴇ ʟᴏɢᴏ ғᴏʀ ʏᴏᴜʀ ᴘʀᴏғɪʟᴇ ᴘɪᴄs.
